...
{
#pragma HLS interface m_axi depth=1 port=MatA_DRAM offset=slave bundle=mem1
#pragma HLS interface m_axi depth=1 port=MatB_DRAM offset=slave bundle=mem2
#pragma HLS interface m_axi depth=1 port=MatC_DRAM offset=slave bundle=mem1
