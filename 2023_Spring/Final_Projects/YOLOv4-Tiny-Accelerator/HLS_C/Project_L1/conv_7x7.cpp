...
#pragma HLS array_partition variable = B_buf dim = 1
    ...
    //---------------------------------------------------------------------------
    // Initializing output elements to bias
    /*
    fm_t tempY_buf[OUT_BUF_DEPTH][OUT_BUF_HEIGHT][OUT_BUF_WIDTH];
    #pragma HLS array_partition variable = tempY_buf dim = 2
    #pragma HLS array_partition variable = tempY_buf dim = 1
    */
