...
)
{
    ...
    wt_t temp_fixp_conv1_bias[32];
    wt_t temp_fixp_conv2_bias[32];
    wt_t temp_fixp_conv3_bias[32];
    wt_t temp_fixp_conv4_bias[32];
    wt_t temp_fixp_dense1_bias[32];
    wt_t temp_fixp_dense2_bias[5];
