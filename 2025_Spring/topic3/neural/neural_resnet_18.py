...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help='Path to the input .npy file (e.g., image_1.npy)'
    )
