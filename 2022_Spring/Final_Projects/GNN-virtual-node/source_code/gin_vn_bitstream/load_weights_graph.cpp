...
// Embeddings, Weights and biases for graph nodes in DRAM
...
// Embeddings, Weights and biases for virtual node in DRAM
...
// Load one graph to DRAM with its node and edge features
